...
public final class ItemsConfig {
    ...
    public static final Item SULFUR_ORE = registerItem("sulfur_ore",
            new BlockItem(BlocksConfig.SULFUR_ORE, new FabricItemSettings().group(ItemGroupsConfig.BLOCKS)));

    public static final Item SILVER_ORE = registerItem("silver_ore",
            new BlockItem(BlocksConfig.SILVER_ORE, new FabricItemSettings().group(ItemGroupsConfig.BLOCKS)));
    ...
    public static final Item RAW_SILVER_BLOCK = registerItem("raw_silver_block",
            new BlockItem(BlocksConfig.RAW_SILVER_BLOCK, new FabricItemSettings().group(ItemGroupsConfig.BLOCKS)));

    public static final Item RAW_LEAD_BLOCK = registerItem("raw_lead_block",
            new BlockItem(BlocksConfig.RAW_LEAD_BLOCK, new FabricItemSettings().group(ItemGroupsConfig.BLOCKS)));
    ...
    public static final Item SILVER_BLOCK = registerItem("silver_block",
            new BlockItem(BlocksConfig.SILVER_BLOCK, new FabricItemSettings().group(ItemGroupsConfig.BLOCKS)));

    public static final Item LEAD_BLOCK = registerItem("lead_block",
            new BlockItem(BlocksConfig.LEAD_BLOCK, new FabricItemSettings().group(ItemGroupsConfig.BLOCKS)));
    ...
    public static final Item GRANITE_MORTAR = registerItem("granite_mortar",
            new BlockItem(BlocksConfig.GRANITE_MORTAR, new FabricItemSettings().group(ItemGroupsConfig.DECORATIONS)));

    public static final Item DIORITE_MORTAR = registerItem("diorite_mortar",
            new BlockItem(BlocksConfig.DIORITE_MORTAR, new FabricItemSettings().group(ItemGroupsConfig.DECORATIONS)));

    public static final Item ANDESITE_MORTAR = registerItem("andesite_mortar",
            new BlockItem(BlocksConfig.ANDESITE_MORTAR, new FabricItemSettings().group(ItemGroupsConfig.DECORATIONS)));

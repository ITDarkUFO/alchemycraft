...
public class MortarHandler extends AbstractRecipeScreenHandler<MortarCraftingInventory> {
    private final MortarCraftingInventory input;
    private final CraftingResultInventory result;
    public final PlayerInventory playerInventory;
    private final ScreenHandlerContext screenHandlerContext;

    public MortarHandler(int syncId, PlayerInventory playerInventory) {
        this(syncId, playerInventory, ScreenHandlerContext.EMPTY);
    }

    public MortarHandler(int syncId, PlayerInventory playerInventory, ScreenHandlerContext context) {

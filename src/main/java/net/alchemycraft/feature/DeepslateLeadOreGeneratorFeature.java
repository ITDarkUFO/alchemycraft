...
public class DeepslateLeadOreGeneratorFeature {
	private static int vein_size = 4, veins_per_chunk = 20, lower_bound = -40;

	private static FeatureConfig OVERWORLD_DEEPSLATE_LEAD_ORE_FEATURE_CONFIG = new OreFeatureConfig(
			OreConfiguredFeatures.DEEPSLATE_ORE_REPLACEABLES,
			BlocksConfig.DEEPSLATE_LEAD_ORE.getDefaultState(),
			vein_size);

	@SuppressWarnings("all")
	private static ConfiguredFeature<?, ?> OVERWORLD_DEEPSLATE_LEAD_ORE_CONFIGURED_FEATURE = new ConfiguredFeature(
			Feature.ORE,
			OVERWORLD_DEEPSLATE_LEAD_ORE_FEATURE_CONFIG);
	...
	public static void init() {
		Registry.register(BuiltinRegistries.CONFIGURED_FEATURE,
				new Identifier(MOD_ID, "overworld_deepslate_lead_ore"),
				OVERWORLD_DEEPSLATE_LEAD_ORE_CONFIGURED_FEATURE);
